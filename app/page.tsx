    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-off-white text-deep-graphite">
      <div className="container mx-auto px-4 py-8 flex flex-col items-center">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="font-obviously font-light text-5xl md:text-6xl mb-8 tracking-tight">
            Research with depth
          </h1>
          <p className="font-cabinet text-light-graphite text-xl mb-12 max-w-2xl mx-auto">
            Get comprehensive research insights with reliable sources on any
            topic
          </p>
            ...
            >
              <div className="relative w-full max-w-2xl">
                <Input
                  ...
                  className="w-full h-16 pl-12 pr-16 rounded-xl bg-off-white border-silver shadow-sm font-cabinet focus-visible:ring-1 focus-visible:ring-deep-graphite"
                  value={query}
                ...
                <Button
                  type="submit"
                  size="icon"
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 h-10 w-10 rounded-xl bg-deep-graphite hover:bg-deep-graphite/90 text-white"
                >
                  <svg
                    width="20"
                    height="20"
              ...
              <div className="mt-6 text-light-graphite text-sm tracking-wide font-cabinet">
                Try: "climate change solutions", "trump tariffs", "healthy meal
                prep ideas"
              </div>
            </form>
          </div>
